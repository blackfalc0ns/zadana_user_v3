    ...
    return BlocConsumer<CategoryViewModel, CategoryState>(
      ...
      builder: (context, state) {
        ...
        return ReusableCategoryScreen(
          ...
          availablePackageTypes: state.availablePackageTypes,
          availableMeasurementUnits: state.availableMeasurementUnits,
          availableMeasurementValues: state.measurementValueOptions,
          availableMeasurementOptions: state.measurementOptions,
          ...
          selectedPackageType: state.filterSelectedPackageType,
          selectedMeasurementUnit: state.filterSelectedMeasurementUnit,
          selectedMeasurementValue: state.filterSelectedMeasurementValue,
