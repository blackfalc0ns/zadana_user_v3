...
class CheckoutDeliveryCheckDto {
  const CheckoutDeliveryCheckDto({
  ...
  factory CheckoutDeliveryCheckDto.fromJson(Map<String, dynamic> json) {
    return CheckoutDeliveryCheckDto(
  ...
  CheckoutDeliveryCheckEntity toEntity() {
    return CheckoutDeliveryCheckEntity(
      status: status,
